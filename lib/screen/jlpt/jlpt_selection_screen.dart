  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          CustomPageButton(onTap: () => goTo('1'), level: '1N'),
          const SizedBox(height: 12),
          CustomPageButton(onTap: () => goTo('2'), level: '2N'),
          const SizedBox(height: 12),
          CustomPageButton(onTap: () => goTo('3'), level: '3N'),
          const SizedBox(height: 12),
          CustomPageButton(onTap: () => goTo('4'), level: '4N'),
          const SizedBox(height: 12),
          CustomPageButton(onTap: () => goTo('5'), level: '5N'),
          const SizedBox(height: 12),
        ],
      ),
    );
