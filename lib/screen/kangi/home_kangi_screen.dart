...
//                 totalProgressCount: userController.user.kangiScores[0],
//                 currentProgressCount: userController.user.currentKangiScores[0],
//                 text: 'N1급 한자',
//                 onTap: () => goTo('1'),
//               ),
//             ),
...
//               child: HomeNaviatorButton(
//                 totalProgressCount: userController.user.kangiScores[1],
...
//               child: HomeNaviatorButton(
//                 totalProgressCount: userController.user.kangiScores[2],
//                 currentProgressCount: userController.user.currentKangiScores[2],
//                 text: 'N3급 한자',
//                 onTap: () => goTo('3'),
//               ),
//             ),
...
//               child: HomeNaviatorButton(
//                 totalProgressCount: userController.user.kangiScores[3],
...
//               child: HomeNaviatorButton(
//                 totalProgressCount: userController.user.kangiScores[4],
