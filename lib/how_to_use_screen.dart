          ...
          const Text.rich(
            TextSpan(
              ...
              children: [
                ...
                TextSpan(text: '어휘력이 중요하다고 강조하고 있고, 어휘력은 단순암기이기 때문에 '),
                TextSpan(
                  text: '잊어버리지 않도록 반복 학습',
                  style: TextStyle(
                    color: Colors.red,
                    fontWeight: FontWeight.bold,
                  ),
                ),
                TextSpan(text: '이 중요하다는 것도 강조 하고 있는 것을 볼 수 있습니다.\n\n'),
                TextSpan(text: ' 그래서 '),
                TextSpan(
                  text: 'JLPT 종각',
                  style: TextStyle(
                ...
                TextSpan(
                    text:
                        ' 처음보는 일본어라도 해당 일본어의 한자를 알고 있다면, 그 뜻을 추측 할 수 있기 때문에 '),
                TextSpan(
                  text: '독해',
                  style: TextStyle(
                    color: Colors.red,
                ...
                TextSpan(
                    text:
                        ' 그래서 JLPT 종각은 일본어 뿐만 아니라, N5급부터 N1급의 한자를 별도로 학습할 수 있고, JLPT N5급부터 N1급의 단어를 학습 하면서도 '),
                TextSpan(
                  text: '한자를 클릭해서 바로바로',
                  style: TextStyle(
                    color: Colors.red,
          ...
          const Text.rich(
            TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  text: '그 후 모르는 단어를 다시 한번 더 확인 합니다.\n\n',
                  style: TextStyle(
                    color: Colors.red,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                TextSpan(text: '모르는 단어가 없을 때 까지 해당 학습 페이지에서 학습 합니다.'),
              ],
            ),
          ),
        ],
          ...
          const Text.rich(
            TextSpan(
              ...
              children: [
                ...
                TextSpan(text: '됩니다.\n\n'),
                TextSpan(text: '전날이나 전전날의 모르는 단어들을 '),
                TextSpan(
                  text: '한번 더 [시험] ',
                  style: TextStyle(
                    color: Colors.red,
